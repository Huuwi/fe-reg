        ...
        <>
            <div className={styles.wrapper} >
                <div>
                    ...
                    <br />
                    <span style={{ backgroundColor: "white", fontSize: "25px", margin: "20px 0px 20px 20px", color: "red" }} >chú ý!!Giá trị quy đổi với không ưu đãi 1 nhìn VND tương đương với 1xu</span>
                    {divsTypeCost}
