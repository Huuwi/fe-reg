        ...
        <>
            ...
            <div className={styles.content} >
                <div className={styles.wrapper}>
                    ...
                    <h2 style={{ color: "red", backgroundColor: "white" }}> <a href="https://youtu.be/IHf-JLSdUCw" style={{ color: "green" }} target="_blank">video hướng dẫn 2 : (hướng dẫn chức năng đăng ký học phần , refund xu nếu đăng ký không thành công) </a></h2>
                </div>
            </div>
        </>
    );
